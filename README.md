...
1. List the core technologies used by the web (CLO 1)
...
2. Explain some important terms used in web development (CLO 1)
* What is a client?
* What is a server?
How do a client and a server communicate over the web?
3. Explain HTTP request and HTTP response (CLO 1)
...
4. Explain the different parts of a URL (CLO 1)
* What is a scheme?
